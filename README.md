...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/loebelch/android_kernel_manifest/android-17.0/manifest_brcm_rpi.xml --create-dirs
```
...
Replace existing files in `device/brcm/rpi5-kernel` directory of the Android source tree to include them in Android 17 build. You can also replace existing files in the boot partition of Raspberry Pi 4 or Raspberry Pi 5 Android 17 image.
